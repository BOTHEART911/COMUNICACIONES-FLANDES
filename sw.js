/* ============================================================
   COMUNICACIONES-FLANDES · SERVICE WORKER DEL CACHÉ
   Fase 9 (el mismo de TESORERÍA y CONTRATACIÓN, con el armazón de esta app)
...
var VERSION = 'comunicaciones-v' + APP_VERSION;
...
var PREFIJO_CACHE = 'comunicaciones-v20';   /* '-v20': la vieja de producción usa 'contratista-v3' y no es de esta */
